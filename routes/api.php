...
Route::put('/schedule/course', 'API\ScheduleController@addScheduledCourse'); //todo
Route::post('/schedule/course', 'API\ScheduleController@editScheduledCourse');//todo - working on it
