...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <form id="course-form" class="form-horizontal" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input class="form-control col-lg-12" type="number" name="credits" value="3" placeholder="3">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <button id="addSectionBtn" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>Add
                        Section
                    </button>
                </div>
